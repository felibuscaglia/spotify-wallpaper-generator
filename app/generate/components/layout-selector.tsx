...
export default function LayoutSelector({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Grid Layout Options */}
      {layout === 'grid' && (
        <div className="space-y-4 p-4 border-2 border-black dark:border-white bg-white dark:bg-[#0f0f0f]">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border-2 border-black dark:border-white text-black dark:text-white focus:outline-none focus:border-[#4ADE80] focus:ring-2 focus:ring-[#4ADE80]/20 bg-white dark:bg-[#0f0f0f]"
            >
